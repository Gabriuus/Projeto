 ...
 * @author aluno
 */
public class DogJade extends javax.swing.JFrame {

    /**
     * Creates new form DogJade
     */
    public DogJade() {
        initComponents();
    }
    ...
    private void btAdotarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAdotarActionPerformed
        // TODO add your handling code here:
        TelaConfirmar tf = new TelaConfirmar();
        tf.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DogJade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
